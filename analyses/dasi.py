...
FIG_DIR=joinpath(FIG_BASE, 'final-report')
try:
    os.makedirs(FIG_DIR)
except OSError:
    if os.path.isdir(FIG_DIR):
        ...
        raise
DATA_DIR=joinpath(DATA_BASE, 'fina-report')
try:
...
if __name__ == '__main__':
    ...
    parser = OptionParser()
    section_choices = ('variation','ntc','hplp','darkdim','sysconf', 'vpen', 'penadj', 'para')
    parser.add_option('--sec', default='para', choices=section_choices,
