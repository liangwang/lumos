...
class MyPlotter(object):
    def __init__(self):
        self.suffix = 'png'
        self.inter = 'false' #interactive on screen
        ...
        for ckt in cktList:
            for ttype in ttypeList:
                ...
                if self.inter:
                    ...
                    ofn = 'errbar_%s_%s.%s' % (ckt, ttype, self.suffix)
...
if __name__ == '__main__':
    ...
    parser.add_option('-i', dest='interactive', action='store_true',
                      default=False, help='interactive seesion')
    ...
    if options.plot_errbar:
        ...
        plot.plotWithErrbar(cktList, ttypeList, techList)
