...
class HeteroSys(object):
    ...
    Args:
       ...
       mech (str):
          Scaling mechanism of the system, possible values are 'HKMGS' and 'LP'.
       tech (num):
    ...
    def realloc_gpacc(self, area_ratio, ctype='FPGA'):
        ...
        Args:
           ...
           ctype (str):
              The type of general-purpose accelerator. Only 'FPGA' is supported.
    ...
    def set_mech(self, mech):
        """
        Set the scaling mechanism of all cores and ucores.
    ...
    def set_core_pv(self, pv):
        ...
        Args:
           pv (bool):
              Set true if process variation need to be considered.
...
class HomoSys(object):
    ...
    def perf_by_vfs(self, vfs, app=App(f=0.99)):
        ...
        scaling the supply voltage by the given factor.
        ...
        Returns:
           ...
           freq (num):
              The frequency of the core, after scaling the supply voltage.
           util (num):
    ...
    def _probe2(self, app=App(f=0.99)):
        core = self.core
        f = app.f
