...
class Base:
    """
    Technology-specific parameters at their nominal value, adopted from McPAT
...
class Scale:
    ...
    """
    ITRS 2009, adopted from 2009Tables_FINAL_ORTC_v14.xls, sheet 2009_ORTC-4, frequency in MHz
...
class ProjScale:
    """
    The same with PTMScale, except for the frequency scaling. Frequency scaling uses factors from ITRS and CONV projections
