...
if LUMOS_DEBUG and ('all' in LUMOS_DEBUG or 'finfet-ltsp' in LUMOS_DEBUG):
    _debug_enabled = True
else:
...
def _debug(brace_msg):
    ...
    if not __logger:
        __logger = logging.getLogger('finfet-ltsp')
...
area_scale = {20: 1, 16: 0.64, 14: 0.49, 10: 0.25, 7: 0.1225}
# Calculated using RCA32 results at nominal supply
fnom_scale = {20: 1, 16: 1.4435, 14: 1.9832, 10: 2.0628, 7: 2.147}
dp_scale = {20: 1, 16: 0.9875, 14: 0.921, 10: 0.7288, 7: 0.5293}
sp_scale = {20: 1, 16: 0.8477, 14: 0.6556, 10: 0.6855, 7: 0.4932}
# The same as fnom_scale
perf_scale = {20: 1, 16: 1.4435, 14: 1.9832, 10: 2.0628, 7: 2.147}
