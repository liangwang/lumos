...
def plot_twinx(x_list, y1_lists, y2_lists,
    ...
    if legend_labels:
        ax1.legend(ax1.lines, legend_labels, loc=legend_loc,
...
def plot_errbar(x_list, y_lists, err_lists, xlabel, ylabel, legend_labels=None,
                legend_loc=None, ylim=None, xlim=None, ylog=False, xgrid=True,
                ygrid=True, title=None, figsize=None, marker_list=None,
    ...
    for y, err, marker, ms in zip(y_lists, err_lists,
                                   icycle(marker_list), icycle(ms_list)):
...
def plot_data_nomarker(x_list, y_lists, xlabel, ylabel, legend_title=None,
                       legend_labels=None, legend_loc=None, ylim=None,
                       xlim=None, ylog=False, xgrid=True, ygrid=True,
                       title=None, figsize=None, marker_list=None,
                       ms_list=None, figdir=None, ofn=None, cb_func=None):
