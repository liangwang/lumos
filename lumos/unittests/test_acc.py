...
from lumos.model import ASAcc as Accelerator
from lumos.model import Kernel, KernelParam
from lumos.model import TFETTechModel, CMOSTechModel
import unittest
...
class TestAccelerator(unittest.TestCase):
    def setUp(self):
        ...
        ker_obj.add_acc('fpga', KernelParam(miu=10))
        ker_obj.add_acc('asic_5x', KernelParam(miu=50))
        ker_obj.add_acc('asic_10x', KernelParam(miu=100))
        ker_obj.add_acc('asic_50x', KernelParam(miu=500))
