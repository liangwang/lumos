...
class Core(object):
    ...
    Core module
    """
    def __init__(self, ctype=None, mech=None, tech=None, pv=False, pen_adjust=None, sigma_level=None):
    ...
    def __update_config(self):
        ...
        if mech == 'ITRS' or mech == 'CONS':
            ...
            f0 = techbase.freq[ctype] * projscl.freq[mech][tech]
            ...
            self._dp0 = techbase.dp[ctype] * projscl.dp[mech][tech]
            self._sp0 = techbase.sp[ctype] * projscl.sp[mech][tech]
    ...
    def config(self, mech=None, ctype=None, tech=None, pv=None, pen_adjust=None, sigma_level=None):
...
if __name__ == '__main__':
    ...
    for mech in mechList:
        ...
        for tech in techList:
            c = Core(tech=tech, mech=mech, ctype='IO')
            #c.config(tech=32)
