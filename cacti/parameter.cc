...
void TechnologyParameter::display(uint32_t indent)
{
  ...
  std::cout << indent_str << "ram_wl_stitching_overhead_ = " << std::setw(12) << ram_wl_stitching_overhead_ << " um" << std::endl;
  std::cout << indent_str << "min_w_nmos_                = " << std::setw(12) << min_w_nmos_                << " um" << std::endl;
  std::cout << indent_str << "max_w_nmos_                = " << std::setw(12) << max_w_nmos_                << " um" << std::endl;
  std::cout << indent_str << "unit_len_wire_del          = " << std::setw(12) << unit_len_wire_del          << " s/um^2" << std::endl;
  std::cout << indent_str << "FO4                        = " << std::setw(12) << FO4                        << " s" << std::endl;
  std::cout << indent_str << "kinv                       = " << std::setw(12) << kinv                       << " s" << std::endl;
  std::cout << indent_str << "vpp                        = " << std::setw(12) << vpp                        << " V" << std::endl;
  std::cout << indent_str << "w_sense_en                 = " << std::setw(12) << w_sense_en                 << " um" << std::endl;
  std::cout << indent_str << "w_sense_n                  = " << std::setw(12) << w_sense_n                  << " um" << std::endl;
  std::cout << indent_str << "w_sense_p                  = " << std::setw(12) << w_sense_p                  << " um" << std::endl;
  std::cout << indent_str << "w_iso                      = " << std::setw(12) << w_iso                      << " um" << std::endl;
  std::cout << indent_str << "w_poly_contact             = " << std::setw(12) << w_poly_contact             << " um" << std::endl;
  std::cout << indent_str << "spacing_poly_to_poly       = " << std::setw(12) << spacing_poly_to_poly       << " um" << std::endl;
  std::cout << indent_str << "spacing_poly_to_contact    = " << std::setw(12) << spacing_poly_to_contact    << " um" << std::endl;
  std::cout << std::endl;
  std::cout << indent_str << "w_comp_inv_p1              = " << std::setw(12) << w_comp_inv_p1 << " um" << std::endl;
  std::cout << indent_str << "w_comp_inv_p2              = " << std::setw(12) << w_comp_inv_p2 << " um" << std::endl;
  std::cout << indent_str << "w_comp_inv_p3              = " << std::setw(12) << w_comp_inv_p3 << " um" << std::endl;
  std::cout << indent_str << "w_comp_inv_n1              = " << std::setw(12) << w_comp_inv_n1 << " um" << std::endl;
  std::cout << indent_str << "w_comp_inv_n2              = " << std::setw(12) << w_comp_inv_n2 << " um" << std::endl;
  std::cout << indent_str << "w_comp_inv_n3              = " << std::setw(12) << w_comp_inv_n3 << " um" << std::endl;
  std::cout << indent_str << "w_eval_inv_p               = " << std::setw(12) << w_eval_inv_p  << " um" << std::endl;
  std::cout << indent_str << "w_eval_inv_n               = " << std::setw(12) << w_eval_inv_n  << " um" << std::endl;
  std::cout << indent_str << "w_comp_n                   = " << std::setw(12) << w_comp_n      << " um" << std::endl;
  std::cout << indent_str << "w_comp_p                   = " << std::setw(12) << w_comp_p      << " um" << std::endl;
  std::cout << std::endl;
  std::cout << indent_str << "dram_cell_I_on             = " << std::setw(12) << dram_cell_I_on << " A/um" << std::endl;
  std::cout << indent_str << "dram_cell_Vdd              = " << std::setw(12) << dram_cell_Vdd  << " V" << std::endl;
  std::cout << indent_str << "dram_cell_I_off_worst_case_len_temp = " << std::setw(12) << dram_cell_I_off_worst_case_len_temp << " A/um" << std::endl;
  std::cout << indent_str << "dram_cell_C                = " << std::setw(12) << dram_cell_C               << " F" << std::endl;
  std::cout << indent_str << "gm_sense_amp_latch         = " << std::setw(12) << gm_sense_amp_latch        << " F/s" << std::endl;
  std::cout << std::endl;
  std::cout << indent_str << "w_nmos_b_mux               = " << std::setw(12) << w_nmos_b_mux              << " um" << std::endl;
  std::cout << indent_str << "w_nmos_sa_mux              = " << std::setw(12) << w_nmos_sa_mux             << " um" << std::endl;
  std::cout << indent_str << "w_pmos_bl_precharge        = " << std::setw(12) << w_pmos_bl_precharge       << " um" << std::endl;
  std::cout << indent_str << "w_pmos_bl_eq               = " << std::setw(12) << w_pmos_bl_eq              << " um" << std::endl;
  std::cout << indent_str << "MIN_GAP_BET_P_AND_N_DIFFS  = " << std::setw(12) << MIN_GAP_BET_P_AND_N_DIFFS << " um" << std::endl;
  std::cout << indent_str << "HPOWERRAIL                 = " << std::setw(12) << HPOWERRAIL                << " um" << std::endl;
  std::cout << indent_str << "cell_h_def                 = " << std::setw(12) << cell_h_def                << " um" << std::endl;

  std::cout << std::endl;
  std::cout << indent_str << "SRAM cell transistor: " << std::endl;
  sram_cell.display(indent + 2);

  std::cout << std::endl;
  std::cout << indent_str << "DRAM access transistor: " << std::endl;
  dram_acc.display(indent + 2);

  std::cout << std::endl;
  std::cout << indent_str << "DRAM wordline transistor: " << std::endl;
  dram_wl.display(indent + 2);

  std::cout << std::endl;
  std::cout << indent_str << "peripheral global transistor: " << std::endl;
  peri_global.display(indent + 2);

  std::cout << std::endl;
  std::cout << indent_str << "wire local" << std::endl;
  wire_local.display(indent + 2);

  std::cout << std::endl;
  std::cout << indent_str << "wire inside mat" << std::endl;
  wire_inside_mat.display(indent + 2);

  std::cout << std::endl;
  std::cout << indent_str << "wire outside mat" << std::endl;
  wire_outside_mat.display(indent + 2);

  std::cout << std::endl;
  std::cout << indent_str << "SRAM" << std::endl;
  sram.display(indent + 2);

  std::cout << std::endl;
  std::cout << indent_str << "DRAM" << std::endl;
